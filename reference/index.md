...
two-sample and paired t-tests, as well as method variants available via
via(): “boot” (bootstrap confidence interval) and “permute” (permutation
test, with a “rfast” engine backed by Rfast2).
